...
const EmployeeView = () => {
	...
	const handleDelete = async (id) => {
		try {
			...
			if (response.ok) {
				setEmployees(
					employees.filter((emp) => emp.e_id !== id)
				);
			...
			if (response.ok) {
				setEmployees((prevEmployees) =>
					prevEmployees.map((emp) =>
						emp.e_id === selectedEmployee.e_id
							? { ...emp, ...values }
							: emp
					)
				);
				...
				<Form form={form} layout="vertical">
					...
					>
						<Select>
							...
							<Select.Option value="Cleaning Staff">
								Cleaning Staff
							</Select.Option>
							<Select.Option value="Inventory Manager">
								Inventory Manager
							</Select.Option>
							...
							<Select.Option value="Customer Help">
								Customer Help
							</Select.Option>
						</Select>
					</Form.Item>
